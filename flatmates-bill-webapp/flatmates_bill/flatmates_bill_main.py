...
days_in_the_house2 = int(input(f"How many days did {name2} spend "
                               f"in the house during the bill period? "))
...
print(f"{flatmate1.name} pays: ",
      round(flatmate1.pays(the_bill, flatmate2), 2))
print(f"{flatmate2.name} pays: ",
      round(flatmate2.pays(the_bill, flatmate1), 2))
