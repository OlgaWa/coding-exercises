...
class Bill:
    """
    Object that contains information about the bill (period, total amount).
    """
...
class Flatmate:
    """
    Creates a flatmate person that lives in the flat and pays the bill.
    """
...
class PdfReport:
    ...
    def generate(self, flatmate1, flatmate2, bill):
        ...
        pdf.cell(100, 25, f"- {flatmate1.name}: {flatmate1_pays} PLN", 0, align="L", ln=1)
        pdf.cell(100, 25, f"- {flatmate2.name}: {flatmate2_pays} PLN", 0, align="L", ln=1)
